...
func newUsersServiceCredentialsApiShowCmd(flags *rootFlags) *cobra.Command {
	...
	cmd.Flags().StringVar(&flagInclude, "include", "", "[String, 'uuid', 'last_login'] Array of additional information to include on the user record. 'locale',...")
