		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if cfg != nil {
				...
				if header == "" {
					...
					report["auth_hint"] = "export CANVAS_LMS_TOKEN=<your-key>"
				} else {
					authConfigured = true
			...
			if os.Getenv("CANVAS_LMS_TOKEN") != "" {
				authEnvSet = append(authEnvSet, "CANVAS_LMS_TOKEN")
				...
				authEnvRequiredMissing = append(authEnvRequiredMissing, "CANVAS_LMS_TOKEN")
			}
			switch {
