...
func newAccountsOutcomeImportsInvalidContentTypeCreatedGroupIdsForAccountsCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			path := "/accounts/{account_id}/outcome_imports/{id}/created_group_ids"
