...
func newUsersContentSharesUpdateCmd(flags *rootFlags) *cobra.Command {
	var bodyReadState string
	var stdinBody bool
	...
	cmd.Flags().StringVar(&bodyReadState, "read-state", "", "Read state for the content share")
