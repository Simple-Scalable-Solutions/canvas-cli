...
func newUsersServiceCredentialsPandataEventsTokenCmd(flags *rootFlags) *cobra.Command {
	var bodyAppKey string
	var stdinBody bool
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			path := "/users/self/pandata_events_token"
	...
	cmd.Flags().StringVar(&bodyAppKey, "app-key", "", "The pandata events appKey for this mobile app")
