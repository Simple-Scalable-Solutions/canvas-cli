...
and full resync. After archiving, use 'search' for instant full-text search.`,
  ...
  canvas-pp-cli workflow archive --full`,
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			resources := []string{"account-calendars", "accounts", "appointment-groups", "audit", "calendar-events", "canvas-lms-search", "canvas-lms-search-all-courses", "conferences", "conversations", "conversations-batches", "conversations-find-recipients", "course-accounts", "course-creation-accounts", "courses", "epub-exports", "manageable-accounts", "media-attachments", "media-objects", "planner", "planner-notes", "planner-overrides", "users", "users-self-course-nicknames", "users-self-favorites-courses", "users-self-favorites-groups", "users-self-groups",  }
			totalSynced := 0
