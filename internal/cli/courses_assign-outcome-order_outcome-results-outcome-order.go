...
func newCoursesAssignOutcomeOrderOutcomeResultsOutcomeOrderCmd(flags *rootFlags) *cobra.Command {
	var stdinBody bool
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			path := "/courses/{course_id}/assign_outcome_order"
