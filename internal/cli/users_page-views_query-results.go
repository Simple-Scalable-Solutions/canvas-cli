...
func newUsersPageViewsQueryResultsCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			path := "/users/{user_id}/page_views/query/{query_id}/results"
			path = replacePathParam(path, "query_id", args[0])
			if len(args) < 2 {
			...
			data, prov, err := resolveRead(cmd.Context(), c, flags, "page-views", false, path, params, nil)
			if err != nil {
