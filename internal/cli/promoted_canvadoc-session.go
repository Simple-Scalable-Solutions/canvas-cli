...
func newCanvadocSessionPromotedCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			path := "/canvadoc_session"
			params := map[string]string{}
			data, prov, err := resolveRead(cmd.Context(), c, flags, "canvadoc-session", false, path, params, nil)
			if err != nil {
