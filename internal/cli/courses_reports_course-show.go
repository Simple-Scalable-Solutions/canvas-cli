...
func newCoursesReportsCourseShowCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			path := "/courses/{course_id}/reports/{report_type}/{id}"
			...
			path = replacePathParam(path, "report_type", args[2])
