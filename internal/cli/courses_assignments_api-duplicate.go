...
func newCoursesAssignmentsApiDuplicateCmd(flags *rootFlags) *cobra.Command {
	...
	cmd.Flags().StringVar(&bodyResultType, "result-type", "", "Optional information: When the root account has the feature `newquizzes_on_quiz_page` enabled and this argument is...")
