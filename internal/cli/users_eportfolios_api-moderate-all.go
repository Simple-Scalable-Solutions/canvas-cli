...
func newUsersEportfoliosApiModerateAllCmd(flags *rootFlags) *cobra.Command {
	...
	cmd.Flags().StringVar(&bodySpamStatus, "spam-status", "", "The spam status for all the ePortfolios")
