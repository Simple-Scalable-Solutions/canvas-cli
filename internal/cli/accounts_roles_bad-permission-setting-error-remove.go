...
func newAccountsRolesBadPermissionSettingErrorRemoveCmd(flags *rootFlags) *cobra.Command {
	...
	cmd.Flags().StringVar(&flagRoleId, "role-id", "", "The unique identifier for the role")
	cmd.Flags().StringVar(&flagRole, "role", "", "The name for the role")
