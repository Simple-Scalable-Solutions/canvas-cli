...
func newAccountsRolesBadPermissionSettingErrorUpdateCmd(flags *rootFlags) *cobra.Command {
	...
	cmd.Flags().StringVar(&bodyLabel, "label", "", "The label for the role. Can only change the label of a custom role that belongs directly to the account.")
