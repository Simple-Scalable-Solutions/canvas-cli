...
func newUsersMobileSessionsServiceCredentialsExpireForUsersCmd(flags *rootFlags) *cobra.Command {
	var flagSkipAdmins bool
	...
	cmd.Flags().BoolVar(&flagSkipAdmins, "skip-admins", false, "If true, will not expire mobile sessions for account administrators.")
