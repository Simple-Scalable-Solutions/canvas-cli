...
func newUsersObserveesUserUpdateCmd(flags *rootFlags) *cobra.Command {
	...
	cmd.Flags().IntVar(&bodyRootAccountId, "root-account-id", 0, "The ID for the root account to associate with the observation link. If not specified, a link will be created for...")
