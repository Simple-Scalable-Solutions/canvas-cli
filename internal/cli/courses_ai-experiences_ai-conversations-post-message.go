...
func newCoursesAiExperiencesAiConversationsPostMessageCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			path := "/courses/{course_id}/ai_experiences/{ai_experience_id}/conversations/{id}/messages"
	...
	cmd.Flags().StringVar(&bodyMessage, "message", "", "The user's message to send to the AI")
