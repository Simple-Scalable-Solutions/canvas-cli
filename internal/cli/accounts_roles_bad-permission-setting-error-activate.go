...
func newAccountsRolesBadPermissionSettingErrorActivateCmd(flags *rootFlags) *cobra.Command {
	var bodyRole string
	var bodyRoleId int
	var stdinBody bool
	...
	cmd.Flags().IntVar(&bodyRoleId, "role-id", 0, "The unique identifier for the role")
