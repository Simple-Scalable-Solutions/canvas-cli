...
func newCoursesGroupCategoriesExportTagsCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			path := "/courses/{course_id}/group_categories/export_tags"
			path = replacePathParam(path, "course_id", args[0])
			params := map[string]string{}
			data, prov, err := resolveRead(cmd.Context(), c, flags, "group-categories", false, path, params, nil)
			if err != nil {
