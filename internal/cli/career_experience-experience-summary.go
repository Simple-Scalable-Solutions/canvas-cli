...
func newCareerExperienceExperienceSummaryCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			path := "/career/experience_summary"
			params := map[string]string{}
			data, prov, err := resolveRead(cmd.Context(), c, flags, "career", false, path, params, nil)
			if err != nil {
