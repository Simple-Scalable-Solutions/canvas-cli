...
func newUsersServiceCredentialsTodoItemsCmd(flags *rootFlags) *cobra.Command {
	...
	cmd.Flags().StringVar(&flagInclude, "include", "", "[String, 'ungraded_quizzes'] 'ungraded_quizzes':: Optionally include ungraded quizzes (such as practice quizzes and...")
