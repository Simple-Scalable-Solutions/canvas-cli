...
func newUsersObserveesUserDestroyCmd(flags *rootFlags) *cobra.Command {
	var flagRootAccountId string
	...
	cmd.Flags().StringVar(&flagRootAccountId, "root-account-id", "", "If specified, only removes the link for the given root account")
