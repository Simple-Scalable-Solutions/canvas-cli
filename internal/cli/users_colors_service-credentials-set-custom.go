...
func newUsersColorsServiceCredentialsSetCustomCmd(flags *rootFlags) *cobra.Command {
	var bodyHexcode string
	var stdinBody bool
	...
	cmd.Flags().StringVar(&bodyHexcode, "hexcode", "", "The hexcode of the color to set for the context, if you choose to pass the hexcode as a query parameter rather than...")
