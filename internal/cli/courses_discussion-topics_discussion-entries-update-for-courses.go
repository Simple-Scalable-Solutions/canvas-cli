...
func newCoursesDiscussionTopicsDiscussionEntriesUpdateForCoursesCmd(flags *rootFlags) *cobra.Command {
	...
	cmd.Flags().StringVar(&bodyMessage, "message", "", "The updated body of the entry.")
