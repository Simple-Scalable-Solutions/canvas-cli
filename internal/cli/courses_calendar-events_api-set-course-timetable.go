...
func newCoursesCalendarEventsApiSetCourseTimetableCmd(flags *rootFlags) *cobra.Command {
	var bodyTimetables string
	var stdinBody bool
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if stdinBody {
				...
				body = map[string]any{}
				if bodyTimetables != "" {
					var parsedTimetables any
					if err := json.Unmarshal([]byte(bodyTimetables), &parsedTimetables); err != nil {
						return fmt.Errorf("parsing --timetables JSON: %w", err)
					}
					body["timetables"] = parsedTimetables
				}
			}
	...
	cmd.Flags().StringVar(&bodyTimetables, "timetables", "", "Timetables")
