...
func newCoursesOutcomeGroupsApiCreateForCoursesCmd(flags *rootFlags) *cobra.Command {
	...
	cmd.Flags().StringVar(&bodyDescription, "description", "", "The description of the new outcome group.")
	cmd.Flags().StringVar(&bodyTitle, "title", "", "The title of the new outcome group.")
