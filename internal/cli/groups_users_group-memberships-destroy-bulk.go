...
func newGroupsUsersGroupMembershipsDestroyBulkCmd(flags *rootFlags) *cobra.Command {
	...
	cmd.Flags().StringVar(&flagUserIds, "user-ids", "", "[Integer] - An array of user IDs to delete memberships in bulk.")
