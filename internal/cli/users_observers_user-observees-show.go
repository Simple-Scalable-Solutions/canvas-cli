...
func newUsersObserversUserObserveesShowCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			path = replacePathParam(path, "observer_id", args[0])
			if len(args) < 2 {
			...
			data, prov, err := resolveRead(cmd.Context(), c, flags, "observers", false, path, params, nil)
			if err != nil {
