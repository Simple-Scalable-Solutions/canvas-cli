...
func newCoursesCspSettingsSetForCoursesCmd(flags *rootFlags) *cobra.Command {
	...
	cmd.Flags().StringVar(&bodyStatus, "status", "", "If set to 'enabled' for an account, CSP will be enabled for all its courses and sub-accounts (that have not...")
