...
func newGroupCategoriesAssignUnassignedMembersGroupCategoriesCmd(flags *rootFlags) *cobra.Command {
	var bodySync bool
	var stdinBody bool
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if flags.asJSON || !isTerminal(cmd.OutOrStdout()) {
				...
				envelope := map[string]any{
					"action":   "post",
					"resource": "assign-unassigned-members",
					"path":     path,
					"status":   statusCode,
	...
	cmd.Flags().BoolVar(&bodySync, "sync", false, "The assigning is done asynchronously by default. If you would like to override this and have the assigning done...")
