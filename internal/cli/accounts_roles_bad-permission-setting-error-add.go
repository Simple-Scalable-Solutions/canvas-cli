...
func newAccountsRolesBadPermissionSettingErrorAddCmd(flags *rootFlags) *cobra.Command {
	var bodyBaseRoleType string
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if stdinBody {
				...
				body = map[string]any{}
				if bodyBaseRoleType != "" {
					body["base_role_type"] = bodyBaseRoleType
				}
				if bodyLabel != "" {
	...
	cmd.Flags().StringVar(&bodyBaseRoleType, "base-role-type", "", "Specifies the role type that will be used as a base for the permissions granted to this role. Defaults to...")
	cmd.Flags().StringVar(&bodyLabel, "label", "", "Label for the role.")
	cmd.Flags().StringVar(&bodyPermissions, "permissions", "", "Permissions")
	cmd.Flags().StringVar(&bodyRole, "role", "", "Deprecated alias for label.")
