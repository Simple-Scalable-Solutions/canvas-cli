...
func newCoursesUsersEnrollmentsApiLastAttendedCmd(flags *rootFlags) *cobra.Command {
	var bodyDate string
	var stdinBody bool
	...
	cmd.Flags().StringVar(&bodyDate, "date", "", "The last attended date of a student enrollment in a course.")
