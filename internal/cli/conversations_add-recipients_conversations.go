...
func newConversationsAddRecipientsConversationsCmd(flags *rootFlags) *cobra.Command {
	...
	cmd.Flags().StringVar(&bodyRecipients, "recipients", "", "[Required, String] An array of recipient ids. These may be user ids or course/group ids prefixed with 'course_' or...")
