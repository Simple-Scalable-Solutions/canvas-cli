...
func newCoursesPermissionsCoursesCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			data, prov, err := resolveRead(cmd.Context(), c, flags, "permissions", false, path, params, nil)
			if err != nil {
	...
	cmd.Flags().StringVar(&flagPermissions, "permissions", "", "[String] List of permissions to check against the authenticated user. Permission names are documented in the...")
