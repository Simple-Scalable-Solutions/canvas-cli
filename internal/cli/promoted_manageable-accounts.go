...
func newManageableAccountsPromotedCmd(flags *rootFlags) *cobra.Command {
	var flagPage string
	var flagPerPage int
	var flagAll bool
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			path := "/manageable_accounts"
			data, prov, err := resolvePaginatedRead(cmd.Context(), c, flags, "manageable-accounts", path, map[string]string{
