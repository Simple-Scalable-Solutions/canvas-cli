...
func newUsersCustomDataDeleteDataCmd(flags *rootFlags) *cobra.Command {
	var flagNs string
	...
	cmd.Flags().StringVar(&flagNs, "ns", "", "The namespace from which to delete the data. This should be something other Canvas API apps aren't likely to use,...")
