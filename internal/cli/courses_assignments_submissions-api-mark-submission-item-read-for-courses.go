...
func newCoursesAssignmentsSubmissionsApiMarkSubmissionItemReadForCoursesCmd(flags *rootFlags) *cobra.Command {
	var stdinBody bool
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			path := "/courses/{course_id}/assignments/{assignment_id}/submissions/{user_id}/read/{item}"
